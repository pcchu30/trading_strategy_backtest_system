...
from .price_handler.dollar_intraday_csv_bar import DollarIntradayCsvBarPriceHandler
...
class TradingSession(object):
    ...
    def _config_session(self):
        ...
        if self.price_handler is None and self.session_type == "backtest":
            self.price_handler = DollarIntradayCsvBarPriceHandler(
    ...
    def start_trading(self, testing=False):
        ...
        #filename = "/home/pcchu/Documents/pythonProjects/qstrader-master/out/tearsheet.png"
        # if not testing:
