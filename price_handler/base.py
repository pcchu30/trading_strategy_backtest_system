...
class AbstractBarPriceHandler(AbstractPriceHandler):
    ...
    def get_last_close(self, ticker):
        ...
        """
        # We may need to change "close" to "adj_close" because if there is a position opening before
        # split, then pnl could be incorrect due to volume unchanged, but sold in a half price.
        # https://github.com/mhallsmoore/qstrader/issues/125
